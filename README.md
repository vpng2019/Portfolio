...
2. **Azure HTTP Mapper:**  
   - [Integration/API transformation](https://github.com/vpng2019/azure-http-mapper)
3. **BizTalk SQL Typed Polling:**  
   - [Employee Data Integration](https://github.com/vpng2019/biztalk-sql-employee-data-polling)
4. **Biztalk EDI Processing:**  
   - [Outbound EDI processing](https://github.com/vpng2019/biztalk-x12-edi-integration)
    
### 💼 Professional Experience

#### **NTT Data** | Project Manager | *Delhi, India* (Jul 2025 – Mar 2026)
...
#### **Textify AI** | Project Manager | *Delhi, India* (Sep 2024 – Jun 2025)
* Led cross-functional Agile teams (Developers, AI Engineers, QA, UI/UX) delivering AI-driven products.
* Facilitated Scrum ceremonies (Sprint Planning, Stand-ups, Retrospectives) and maintained project risk registers.
* Tracked roadmaps, resource allocation, and milestone dependencies to prevent delivery bottlenecks.

#### **Baloise Insurance** | Senior Integration Specialist | *Antwerp, Belgium* (May 2023 – Aug 2024)
...
#### **Puratos Food Manufacturing** | Senior Software Professional | *Brussels, Belgium* (Aug 2021 – Jan 2023)
...
#### **Abu Dhabi Distribution Company** | Senior Consultant | *Abu Dhabi, UAE* (Jun 2019 – Jan 2021)
...
#### **Emaar Hospitality** | Senior Software Engineer | *Dubai, UAE* (May 2018 – May 2019)
...
#### **CSC / DXC Technology** | Senior Software Engineer / Team Lead | *Bangalore, India* (Feb 2017 – Oct 2017)
* Led engineering teams through end-to-end client delivery, Visual Studio orchestration designs, and BRE rules deployment.

#### **Accenture** | Senior Software Engineer / Team Lead | *Bangalore, India* (Jul 2013 – Jan 2017)
...
#### **Tata Consultancy Services (TCS)** | System Engineer | *Delhi, India* (Jun 2011 – Jul 2013)
* Initiated and developed the U.S. Customs integration project for ZIM Shipping using BizTalk 2010 and C#.NET.
* Conducted EAI training courses for client teams and mentored engineers on middleware best practices.

#### **Mindgate Solutions** | IT Associate | *Delhi, India* (Dec 2010 – May 2011)
* Developed C#.NET libraries, envelope schemas, and multi-bank XML generation scripts via SQL Server stored procedures.

#### **Nihilent Technologies** | Systems Engineer | *Pune, India* (Apr 2008 – Jun 2010)
* Built, tested, and deployed foundational BizTalk orchestrations, schemas, and mapping interfaces.
