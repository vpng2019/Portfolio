...
* Global work experience of working out of India, Middle East (Dubai, Abu Dhabi), Europe (Belgium).
...
* Spearheaded the development of complex EDI integration Projects using X12 and EDIFACT standards, enabling seamless data exchange with key
business partners.

* Proven track record of global delivery as Lead.
...
* Developed complex orchestrations, XSLT maps, XSD schemas in Biztalk Server.
...
`Apr 2008 – Jun 2010` | *India*
* Prepared BizTalk related documentation, for the project involved in Developing orchestration, XSD schemas.
